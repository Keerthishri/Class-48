...
if((keyDown("UP_ARROW")||touches.length>0)&&player.y>height/3){
  player.y = player.y-30
}
if((keyDown("DOWN_ARROW")||touches.length>0)&&player.y<height-100){
 player.y = player.y+30
}
...
function enemy(){
  if(frameCount%150===0){
    ...
    zombie = createSprite(random(500,1100),random(height/3, height-100),40,40)
